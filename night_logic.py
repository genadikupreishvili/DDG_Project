...
rfnoneed = [14007, 14229, 11094, 11873, 12618, 14196, 14197, 14059, 10313, 12527, 10216, 10467, 12955, 12259, 14242,
            12019, 14137, 14239, 10084, 10403, 11365, 14182, 11792, 14244, 14234, 14059, 12527, 14272, 14273, 14264,
            14275, 14276, 14259]
...
base_inside = [12282, 10572, 12057, 12270, 12076, 10458, 12942, 12921, 12252, 12576, 11996, 12151, 12703, 12108, 12644,
               ...
               12161, 10256, 12283, 12707, 14051, 10531, 14018, 12766, 14224, 12819, 12878, 10687, 12815, 12294, 14239,
               14247, 12250, 11976, 14201, 14210, 12165, 14300]
...
# კუპიურის რაოდენობის ლოგიკაა კიდე დასამატებელი
...
for i in terminal_ID:
    ...
    # --- გლდანი მონეტის ლოგიკა
        ...
        gldani_coin.append(
            ...
            dict_id_coin_time[i] > 300:
        gldani_coin.append(
            f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_coin_time[i])} __{dict_id_address[i]}')
    elif dict_id_district[i] == 'გლდანი-ნაძალადევი' and dict_id_categori[i] == 5 and i not in base_inside and \
            dict_id_coin_time[i] > 360:
        gldani_coin.append(
            f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_coin_time[i])} __{dict_id_address[i]}')

    # ---- გლდანი რფ-ის ლოგიკა >>>>:
    elif dict_id_district[i] == 'გლდანი-ნაძალადევი' and dict_id_categori[i] == 1 and i not in base_inside and \
            dict_id_card_time[i] > 240:
        gldani_rf.append(f'{str(i)} ({dict_id_categori[i]}) {dict_id_card_time[i] // 60}-სთ {dict_id_address[i]} ')
    elif dict_id_district[i] == 'გლდანი-ნაძალადევი' and dict_id_categori[i] == 2 and i not in base_inside and \
            dict_id_card_time[i] > 300:
        gldani_rf.append(f'{str(i)} ({dict_id_categori[i]}) {dict_id_card_time[i] // 60}-სთ {dict_id_address[i]} ')
    elif dict_id_district[i] == 'გლდანი-ნაძალადევი' and dict_id_categori[i] == 3 and i not in base_inside and \
            dict_id_card_time[i] > 360 and i not in rfnoneed:
        gldani_rf.append(f'{str(i)} ({dict_id_categori[i]}) {dict_id_card_time[i] // 60}-სთ {dict_id_address[i]} ')
    elif dict_id_district[i] == 'გლდანი-ნაძალადევი' and dict_id_categori[i] == 4 and i not in base_inside and \
            dict_id_card_time[i] > 600 and i not in rfnoneed:
        gldani_rf.append(f'{str(i)} ({dict_id_categori[i]}) {dict_id_card_time[i] // 60}-სთ {dict_id_address[i]} ')
    elif dict_id_district[i] == 'გლდანი-ნაძალადევი' and dict_id_categori[i] == 5 and i not in base_inside and \
            dict_id_card_time[i] > 800 and i not in rfnoneed:
        gldani_rf.append(f'{str(i)} ({dict_id_categori[i]}) {dict_id_card_time[i] // 60}-სთ {dict_id_address[i]} ')
    ...
    elif dict_id_district[i] == 'დიდუბე-ჩუღურეთი' and dict_id_categori[i] == 1 and dict_id_tr_time[i] > 180:
        didube_trans.append(
            f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_tr_time[i])} __{dict_id_address[i]}')
    elif dict_id_district[i] == 'დიდუბე-ჩუღურეთი' and dict_id_categori[i] == 2 and dict_id_tr_time[i] > 180:
        didube_trans.append(
            f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_tr_time[i])} __{dict_id_address[i]}')
    elif dict_id_district[i] == 'დიდუბე-ჩუღურეთი' and dict_id_categori[i] == 3 and dict_id_tr_time[i] > 180:
        didube_trans.append(
            f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_tr_time[i])} __{dict_id_address[i]}')
    ...
    elif dict_id_district[i] == 'საბურთალო' and dict_id_categori[i] == 1 and dict_id_tr_time[i] > 180:
        saburtalo_trans.append(
            f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_tr_time[i])} __{dict_id_address[i]}')
    elif dict_id_district[i] == 'საბურთალო' and dict_id_categori[i] == 2 and dict_id_tr_time[i] > 180:
        saburtalo_trans.append(
            f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_tr_time[i])} __{dict_id_address[i]}')
    elif dict_id_district[i] == 'საბურთალო' and dict_id_categori[i] == 3 and dict_id_tr_time[i] > 180:
        saburtalo_trans.append(
            f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_tr_time[i])} __{dict_id_address[i]}')
    ...
    elif dict_id_district[i] == 'ვაკე-ვერა-მთაწმინდა' and dict_id_categori[i] == 1 and dict_id_tr_time[i] > 180:
        vake_trans.append(f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_tr_time[i])} __{dict_id_address[i]}')
    elif dict_id_district[i] == 'ვაკე-ვერა-მთაწმინდა' and dict_id_categori[i] == 2 and dict_id_tr_time[i] > 180:
        vake_trans.append(f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_tr_time[i])} __{dict_id_address[i]}')
    elif dict_id_district[i] == 'ვაკე-ვერა-მთაწმინდა' and dict_id_categori[i] == 3 and dict_id_tr_time[i] > 180:
        vake_trans.append(f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_tr_time[i])} __{dict_id_address[i]}')
    ...
    elif dict_id_district[i] == 'ისანი-სამგორი' and dict_id_categori[i] == 1 and dict_id_tr_time[i] > 180:
        isani_trans.append(f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_tr_time[i])} __{dict_id_address[i]}')
    elif dict_id_district[i] == 'ისანი-სამგორი' and dict_id_categori[i] == 2 and dict_id_tr_time[i] > 180:
        isani_trans.append(f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_tr_time[i])} __{dict_id_address[i]}')
    elif dict_id_district[i] == 'ისანი-სამგორი' and dict_id_categori[i] == 3 and dict_id_tr_time[i] > 180:
        isani_trans.append(f'{str(i)} ({dict_id_categori[i]}) {Hourtominut(dict_id_tr_time[i])} __{dict_id_address[i]}')
